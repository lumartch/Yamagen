<?php
	...
	$select = "SELECT id, nomPub, id_academico FROM MANUAL_OPERACION WHERE id_academico = '$id_academico'";
			...
			<li>
				...
				<table>
					<tr>
						...
						<button id="modificar'.$i.'" type="button" name="modificar'.$i.'" onclick="modificarDatos('.$row["id"].', 5)">Modificar</button>
