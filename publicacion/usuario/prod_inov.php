			...
			<li>
				...
				<table>
					<tr>
						...
						<button id="modificar'.$i.'" type="button" name="modificar'.$i.'" onclick="modificarDatos('.$row["id"].', 6)">Modificar</button>
						<button id="ver'.$i.'" type="button" name="ver'.$i.'" onclick="verDatos('.$row["id"].', 6)">Ver</button>
					</tr>
				</table>
			</li>';
			$i++;
